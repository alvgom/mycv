...
% \definecolor{awesome}{HTML}{FFCCFF} % Uncomment if you would like to specify your own color
...
\name{Alvaro}{Gomariz}
\address{Computer Vision Laboratory, ETF C108, 
Sternwartstrasse 7
ETH Zentrum
8092 Zürich, Switzerland}
% \mobile{(+82) 10-9030-1843}

\email{alvaroeg@vision.ee.ethz.ch}
% \homepage{www.posquit0.com}
\github{https://github.com/alvgom}
\linkedin{https://www.linkedin.com/in/alvarogomariz}
%\skype{skypeid}

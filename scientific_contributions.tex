...
\makecvfooter{\today}{Alvaro Gomariz~~~·~~~Additional Information}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

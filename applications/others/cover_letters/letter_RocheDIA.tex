...
\letterdate{Zurich, 27th February 2022} % The date on the letter, default is the date of compilation

\lettertitle{Application for PHC Data Scientist, DAI} % The title of the letter

\letteropening{Dear Dr. Korski,} % How the letter is opened
...
During the past year I also have had the opportunity to closely interact with the Data, Analytics and Imaging (DAI) group, due to the joint efforts in ophthalmology (retinal segmentation), and as part of their ML journal club. I am therefore already confident about my positive synergy with the people and ways of working in DAI. I am also motivated about the possibility to expand my image analysis and management skills, including domain knowledge in digital pathology. 
...
I thank you for taking the time to review my application and look forward to further discussing the opportunities with you. 
\end{flushleft}

...
\ifthenelse{\equal{\authornames}{short}}
    ...
    {Blasco Fernandez P, Girycki R, Bossuyt P, Daperno M, Kopylov U, Bouhnik Y, Karmiris K, Stimpel B, Levitte S, \textbf{Gomariz A}}
}
{Evaluating the Impact of Temporal Video Context on the Assessment of Endoscopic Scoring in Ulcerative Colitis}
{United European Gastroenterology Journal, UEG Week 2026 (accepted)}
{}
{2026}
{}
...
{Characterizing the Reliability and Scalability of Granular Mucosal Labeling in Ulcerative Colitis Across Rater Groups}
{United European Gastroenterology Journal, UEG Week 2026 (accepted)}
{}
{2026}
{}
...
{Quantifying the Spatial Inter-Rater Reliability of Mucosal Lesion Annotations in Ulcerative Colitis}
{Digestive Disease Week (DDW), abstract}
{(2026)}
{}
{}
...
\ifthenelse{\equal{\authornames}{short}}
    {\textbf{Gomariz A}, et al.~,}
    {\textbf{Gomariz A}, Szostak P, Girycki R, Stimpel B, Abbasi-Sureshjani S, Levitte S, Karrer T}
}
{Leveraging Global Video Context to Automate Colon Section Identification in Ulcerative Colitis Endoscopy}
...
\ifthenelse{\equal{\authornames}{short}}
    {\textbf{Gomariz A}, et al.~,}
    {\textbf{Gomariz A}, Stimpel B, Stefanescu C, Gutierrez-Becker B, Fr\"assle S, Girycki R, Fisher E, Bouhnik Y, Levitte S, Karrer T}
}
{Real-World Evidence Validates AI-Based Endoscopic Scoring for Ulcerative Colitis}
{United European Gastroenterology Journal}
{Volume 13, Issue S8}
{2025}
{}
